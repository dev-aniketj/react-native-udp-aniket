...
export default class UdpSocket extends EventEmitter {
     ...
     */
    send(msg: string | Buffer | Uint8Array | Array<any>, offset?: number | undefined, length?: number | undefined, port?: number | undefined, address?: string | undefined, callback?: ((error?: Error) => void) | undefined): void;
    /**
     * @private
